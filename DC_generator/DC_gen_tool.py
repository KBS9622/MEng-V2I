...
class DP(object):
    ...
    def generate_driving_pulse(self, velocity_noise_obj):
        ...
        idle_time_values = np.linspace(current_time, (current_time + int(1000 * self.idle_duration_value)),
                                       int(1000 * self.idle_duration_value) + 1)
        idle_time = 0 * idle_time_values
...
class Attribute(object):
    ...
    def __init__(self, array):
        ...
        self.bins = pd.DataFrame(np.linspace(new_first_bin_edge, new_last_bin_edge - (bin_width / repeat_factor),
                                             num=repeat_factor * new_num_of_bins))
...
if __name__ == '__main__':
    ...
    file_name = '../../../Downloads/device12_oct_7_to_10_classified_updated.csv'
    subdir = ''
