...
# tou_obj.create_and_fit_model(seasonality=48, fitted_model_filename='mbp_TOU_48.pickle')
...
pred = tou_obj.predict_and_compare(start_time, end_time, fitted_model_filename='mbp_TOU_48.pickle')
